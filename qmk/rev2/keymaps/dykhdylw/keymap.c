...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |   [  |   ]  |   N  |   M  |   ,  |   .  |   /  |  `   |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl | GUI  | Alt  |Adjust| Mhen |Lower |Space |Enter |Raise |  Henk | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL, KC_LALT, KC_LGUI, ADJUST,  KC_MHEN, LOWER,  KC_SPC,  KC_ENT,  RAISE,   KC_HENK,  KC_LEFT,  KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, _______, _______, KC_END,  _______, _______,                   _______, KC_PGUP, _______, KC_PGDN, _______, _______, \
      _______, KC_HOME, _______, _______, _______, _______,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, \
      _______, _______, _______, _______, _______, _______, KC_F11,  KC_F12,  _______, _______, _______, KC_HOME, KC_END,  _______, \
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_UNDS, KC_PLUS, KC_PGDN, KC_PGUP, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
